return {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap("n", "<leader>gr", '<cmd>:Gread<cr>', { silent = true, desc = "Checkout current file" })
    vim.api.nvim_set_keymap("n", "<leader>gc", '<cmd>:Git commit<cr>', { silent = true, desc = "Commit staged files" })
